...
Graham 的核心：以远低于内在价值的价格买入，为判断出错留出缓冲。差价越大，容错越高。

**内在价值 (Intrinsic Value)**
公司未来自由现金流的折现值——它「实际值多少」，与市场报价无关。求大致正确，而非精确。

**价值陷阱 (Value Trap)**
看着便宜（低 P/E / P/B），但基本面在持续恶化，便宜是「应该的」——估值再低也接不住下跌。
...
**市场先生 (Mr. Market)**
Graham 的寓言：市场像个情绪躁狂的合伙人，每天报不同的价。只在他极度悲观时买、极度乐观时卖，平时不必理他。

**第二层思维 (Second-Level Thinking)**
Howard Marks：第一层是「这是好公司」；第二层追问「好到什么程度、价格是否已反映、我与市场预期有何不同」。超额收益来自与众不同且正确。

**市场周期 (Market Cycle)**
估值、情绪、信贷的钟摆式往复。不预测拐点，但据「我们处在周期哪个位置」调整谨慎度。

**多元思维模型 (Mental Models)**
Munger：把跨学科的基本原理组成一张「格栅」，从心理学 / 数学 / 物理 / 生物等多个角度交叉检验一桩生意。

**逆向思考 (Inversion)**
Munger 常用：「反过来想」。与其问「怎么成功」，先问「怎么必然失败」，然后避开它。
